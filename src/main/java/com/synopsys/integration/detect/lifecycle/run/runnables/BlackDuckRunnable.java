...
public class BlackDuckRunnable implements DetectRunnable {
    ...
    public BlackDuckRunnable(DetectContext detectContext, ProductRunData productRunData, DetectConfigurationFactory detectConfigurationFactory, DirectoryManager directoryManager,
        EventSystem eventSystem, CodeLocationNameManager codeLocationNameManager, BdioCodeLocationCreator bdioCodeLocationCreator, DetectInfo detectInfo, DetectToolFilter detectToolFilter,
        AggregateOptions aggregateOptions, ImpactAnalysisOptions impactAnalysisOptions) {
