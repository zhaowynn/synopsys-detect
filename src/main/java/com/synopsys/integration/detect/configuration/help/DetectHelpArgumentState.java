...
public class DetectHelpArgumentState {
    ...
    public DetectHelpArgumentState(final boolean isHelp, final boolean isHelpJsonDocument, final boolean isVerboseHelp, final boolean isDeprecatedHelp) {
        this.isHelp = isHelp;
