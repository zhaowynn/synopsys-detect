...
public class ShutdownManager {
    ...
    public void shutdown(Optional<ProductRunData> productRunData, Optional<File> airgapZip, Optional<PropertyConfiguration> detectConfigurationOptional, Optional<DirectoryManager> directoryManagerOptional,
    ...
    private void cleanupRun(Optional<ProductRunData> productRunData, Optional<File> airgapZip, DirectoryManager directoryManager, PropertyConfiguration detectConfiguration) {
        try {
            if (detectConfiguration.getValue(DetectProperties.DETECT_CLEANUP)) {
