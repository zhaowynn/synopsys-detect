...
public class DetectConfigurationFactoryTests {
    ...
    public void parallelProcessorsPrefersNewProperty() {
        DetectConfigurationFactory factory = factoryOf(
            Pair.of(DetectProperties.DETECT_PARALLEL_PROCESSORS, "5"),
            Pair.of(DetectProperties.DETECT_BLACKDUCK_SIGNATURE_SCANNER_PARALLEL_PROCESSORS, "4")
        );
    ...
    public void parallelProcessorsFallsBackToOldProperty() {
        DetectConfigurationFactory factory = factoryOf(
            Pair.of(DetectProperties.DETECT_BLACKDUCK_SIGNATURE_SCANNER_PARALLEL_PROCESSORS, "5")
        );
    ...
    public void snippetMatchingDeprecatedPropertyEnablesSnippets() {
        DetectConfigurationFactory factory = factoryOf(
            Pair.of(DetectProperties.DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MODE, "true")
        );
    ...
    public void snippetMatchingPrefersNewerProperty() {
        DetectConfigurationFactory factory = factoryOf(
            Pair.of(DetectProperties.DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MODE, "true"),
            Pair.of(DetectProperties.DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MATCHING, SnippetMatching.FULL_SNIPPET_MATCHING_ONLY.name())
        );
