...
public class SystemPathExecutableFinder {
    ...
    public SystemPathExecutableFinder(final SimpleExecutableFinder executableFinder) {
    ...
    public File findExecutable(final String executable) {
        ...
        final File found = executableFinder.findExecutable(executable, systemPathLocations);
        if (found == null) {
