...
public class RunManager {
    ...
    public RunResult run(ProductRunData productRunData) throws DetectUserFriendlyException, IntegrationException {
        ...
        UniversalProjectToolsRunnable universalProjectToolsRunnable = new UniversalProjectToolsRunnable(detectConfiguration, detectConfigurationFactory, directoryManager, eventSystem, detectDetectableFactory, detectToolFilter);
