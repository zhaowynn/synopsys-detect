...
public enum DetectProperty {
    ...
    DETECT_DOCKER_INSPECTOR_AIR_GAP_PATH("detect.docker.inspector.air.gap.path", "Docker Inspector AirGap Path", "3.0.0", PropertyType.STRING, PropertyAuthority.AIR_GAP_MANAGER),
    ...
    DETECT_GRADLE_INSPECTOR_AIR_GAP_PATH("detect.gradle.inspector.air.gap.path", "Gradle Inspector AirGap Path", "3.0.0", PropertyType.STRING, PropertyAuthority.AIR_GAP_MANAGER),
    ...
    DETECT_OUTPUT_PATH("detect.output.path", "Detect Output Path", "3.0.0", PropertyType.STRING, PropertyAuthority.DIRECTORY_MANAGER),
    ...
    DETECT_TOOLS_OUTPUT_PATH("detect.tools.output.path", "Detect Tools Output Path", "5.6.0", PropertyType.STRING, PropertyAuthority.DIRECTORY_MANAGER),
    ...
    DETECT_SCAN_OUTPUT_PATH("detect.scan.output.path", "Scan Output Path", "3.0.0", PropertyType.STRING, PropertyAuthority.DIRECTORY_MANAGER),
    ...
    DETECT_SOURCE_PATH("detect.source.path", "Source Path", "3.0.0", PropertyType.STRING, PropertyAuthority.DIRECTORY_MANAGER),
