...
public class SolutionParserTest {
    ...
    void CanParseProject() {
        List<String> solutionLines = Arrays.asList("Project(\"{9A19103F-16F7-4668-BE54-9A1E7A4F7556}\") = \"NugetDotnet5Inspector\", \"NugetDotnet5Inspector\\NugetDotnet5Inspector.csproj\", \"{AEDCF063-2341-465D-B256-39125610E39B}\""
            , "EndProject");
