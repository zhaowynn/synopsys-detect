...
public class DetectProperties {
    ...
    public static final NullableStringProperty BLACKDUCK_API_TOKEN =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.api.token"))
    ...
    public static final BooleanProperty BLACKDUCK_OFFLINE_MODE =
        new PropertyBuilder<>(new BooleanProperty("blackduck.offline.mode", false))
    ...
    public static final NullableStringProperty BLACKDUCK_PASSWORD =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.password"))
    ...
    public static final NullableStringProperty BLACKDUCK_PROXY_HOST =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.host"))
    ...
    public static final StringListProperty BLACKDUCK_PROXY_IGNORED_HOSTS =
        new PropertyBuilder<>(new StringListProperty("blackduck.proxy.ignored.hosts", emptyList()))
    ...
    public static final NullableStringProperty BLACKDUCK_PROXY_NTLM_DOMAIN =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.ntlm.domain"))
    ...
    public static final NullableStringProperty BLACKDUCK_PROXY_NTLM_WORKSTATION =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.ntlm.workstation"))
    ...
    public static final NullableStringProperty BLACKDUCK_PROXY_PASSWORD =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.password"))
    ...
    public static final NullableStringProperty BLACKDUCK_PROXY_PORT =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.port"))
    ...
    public static final NullableStringProperty BLACKDUCK_PROXY_USERNAME =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.proxy.username"))
    ...
    public static final IntegerProperty BLACKDUCK_TIMEOUT =
        new PropertyBuilder<>(new IntegerProperty("blackduck.timeout", 120))
    ...
    public static final BooleanProperty BLACKDUCK_TRUST_CERT =
        new PropertyBuilder<>(new BooleanProperty("blackduck.trust.cert", false))
    ...
    public static final NullableStringProperty BLACKDUCK_URL =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.url"))
            .setInfo("Black Duck URL", "4.2.0")
            .setHelp("URL of the Black Duck server.")
            .setGroups(DetectGroup.BLACKDUCK_SERVER, DetectGroup.BLACKDUCK, DetectGroup.DEFAULT)
            .build();

    public static final NullableStringProperty BLACKDUCK_USERNAME =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.username"))
    ...
    public static final IntegerProperty DETECT_PARALLEL_PROCESSORS =
        new PropertyBuilder<>(new IntegerProperty("detect.parallel.processors", 1))
    ...
    public static final NullablePathProperty DETECT_BASH_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.bash.path"))
    ...
    public static final NullablePathProperty DETECT_BAZEL_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.bazel.path"))
    ...
    public static final NullableStringProperty DETECT_BAZEL_TARGET =
        new PropertyBuilder<>(new NullableStringProperty("detect.bazel.target"))
    ...
    public static final StringListProperty DETECT_BAZEL_CQUERY_OPTIONS =
        new PropertyBuilder<>(new StringListProperty("detect.bazel.cquery.options", emptyList()))
    ...
    public static final FilterableEnumListProperty<WorkspaceRule> DETECT_BAZEL_DEPENDENCY_RULE =
        new PropertyBuilder<>(new FilterableEnumListProperty<>("detect.bazel.dependency.type", emptyList(), WorkspaceRule.class))
    ...
    public static final NullablePathProperty DETECT_BDIO_OUTPUT_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.bdio.output.path"))
    ...
    public static final BooleanProperty DETECT_BDIO2_ENABLED =
        new PropertyBuilder<>(new BooleanProperty("detect.bdio2.enabled", false))
    ...
    public static final NullablePathProperty DETECT_BINARY_SCAN_FILE =
        new PropertyBuilder<>(new NullablePathProperty("detect.binary.scan.file.path"))
    ...
    public static final StringListProperty DETECT_BINARY_SCAN_FILE_NAME_PATTERNS =
        new PropertyBuilder<>(new StringListProperty("detect.binary.scan.file.name.patterns", emptyList()))
    ...
    public static final StringProperty DETECT_BITBAKE_BUILD_ENV_NAME =
        new PropertyBuilder<>(new StringProperty("detect.bitbake.build.env.name", "oe-init-build-env"))
    ...
    public static final StringListProperty DETECT_BITBAKE_PACKAGE_NAMES =
        new PropertyBuilder<>(new StringListProperty("detect.bitbake.package.names", emptyList()))
    ...
    public static final StringListProperty DETECT_BITBAKE_SOURCE_ARGUMENTS =
        new PropertyBuilder<>(new StringListProperty("detect.bitbake.source.arguments", emptyList()))
    ...
    public static final IntegerProperty DETECT_BITBAKE_SEARCH_DEPTH =
        new PropertyBuilder<>(new IntegerProperty("detect.bitbake.search.depth", 1))
    ...
    public static final NullableStringProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_ARGUMENTS =
        new PropertyBuilder<>(new NullableStringProperty("detect.blackduck.signature.scanner.arguments"))
    ...
    public static final BooleanProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_COPYRIGHT_SEARCH =
        new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.copyright.search", false))
    ...
    public static final BooleanProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_DRY_RUN =
        new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.dry.run", false))
    ...
    public static final StringListProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS =
        new PropertyBuilder<>(
    ...
    public static final IntegerProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_PATTERN_SEARCH_DEPTH =
        new PropertyBuilder<>(new IntegerProperty("detect.blackduck.signature.scanner.exclusion.pattern.search.depth", 4))
    ...
    public static final StringListProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_PATTERNS =
        new PropertyBuilder<>(new StringListProperty("detect.blackduck.signature.scanner.exclusion.patterns", emptyList()))
    ...
    public static final NullableStringProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_HOST_URL =
        new PropertyBuilder<>(new NullableStringProperty("detect.blackduck.signature.scanner.host.url"))
    ...
    public static final BooleanProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_LICENSE_SEARCH =
        new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.license.search", false))
    ...
    public static final NullablePathProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_LOCAL_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.blackduck.signature.scanner.local.path"))
    ...
    public static final IntegerProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_MEMORY =
        new PropertyBuilder<>(new IntegerProperty("detect.blackduck.signature.scanner.memory", 4096))
    ...
    public static final NullablePathProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.blackduck.signature.scanner.offline.local.path"))
    ...
    public static final PathListProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_PATHS =
        new PropertyBuilder<>(new PathListProperty("detect.blackduck.signature.scanner.paths", emptyList()))
    ...
    public static final ExtendedEnumProperty<ExtendedSnippetMode, SnippetMatching> DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MATCHING =
        new PropertyBuilder<>(new ExtendedEnumProperty<>("detect.blackduck.signature.scanner.snippet.matching", ExtendedEnumValue.ofExtendedValue(ExtendedSnippetMode.NONE), ExtendedSnippetMode.class, SnippetMatching.class))
    ...
    public static final BooleanProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_UPLOAD_SOURCE_MODE =
        new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.upload.source.mode", false))
    ...
    public static final NullableStringProperty DETECT_BOM_AGGREGATE_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.bom.aggregate.name"))
    ...
    public static final EnumProperty<AggregateMode> DETECT_BOM_AGGREGATE_REMEDIATION_MODE =
        new PropertyBuilder<>(new EnumProperty<>("detect.bom.aggregate.remediation.mode", AggregateMode.TRANSITIVE, AggregateMode.class))
    ...
    public static final BooleanProperty DETECT_BUILDLESS =
        new PropertyBuilder<>(new BooleanProperty("detect.detector.buildless", false))
    ...
    public static final BooleanProperty DETECT_CLEANUP =
        new PropertyBuilder<>(new BooleanProperty("detect.cleanup", true))
    ...
    public static final NullableStringProperty DETECT_CLONE_PROJECT_VERSION_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.clone.project.version.name"))
    ...
    public static final BooleanProperty DETECT_CLONE_PROJECT_VERSION_LATEST =
        new PropertyBuilder<>(new BooleanProperty("detect.clone.project.version.latest", false))
    ...
    public static final NullableStringProperty DETECT_CODE_LOCATION_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.code.location.name"))
    ...
    public static final NullableStringProperty DETECT_CONDA_ENVIRONMENT_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.conda.environment.name"))
    ...
    public static final NullablePathProperty DETECT_CONDA_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.conda.path"))
    ...
    public static final NullablePathProperty DETECT_CPAN_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.cpan.path"))
    ...
    public static final NullablePathProperty DETECT_CPANM_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.cpanm.path"))
            .setInfo("cpanm Executable", "3.0.0")
            .setHelp("The path to the cpanm executable.")
            .setGroups(DetectGroup.CPAN, DetectGroup.GLOBAL)
            .build();

    public static final EnumProperty<DefaultVersionNameScheme> DETECT_DEFAULT_PROJECT_VERSION_SCHEME =
        new PropertyBuilder<>(new EnumProperty<>("detect.default.project.version.scheme", DefaultVersionNameScheme.TEXT, DefaultVersionNameScheme.class))
    ...
    public static final StringProperty DETECT_DEFAULT_PROJECT_VERSION_TEXT =
        new PropertyBuilder<>(new StringProperty("detect.default.project.version.text", "Default Detect Version"))
    ...
    public static final StringProperty DETECT_DEFAULT_PROJECT_VERSION_TIMEFORMAT =
        new PropertyBuilder<>(new StringProperty("detect.default.project.version.timeformat", "yyyy-MM-dd'T'HH:mm:ss.SSS"))
    ...
    public static final IntegerProperty DETECT_DETECTOR_SEARCH_DEPTH =
        new PropertyBuilder<>(new IntegerProperty("detect.detector.search.depth", 0))
    ...
    public static final BooleanProperty DETECT_DETECTOR_SEARCH_CONTINUE =
        new PropertyBuilder<>(new BooleanProperty("detect.detector.search.continue", false))
    ...
    public static final StringListProperty DETECT_DETECTOR_SEARCH_EXCLUSION =
        new PropertyBuilder<>(new StringListProperty("detect.detector.search.exclusion", emptyList()))
    ...
    public static final StringListProperty DETECT_DETECTOR_SEARCH_EXCLUSION_PATTERNS =
        new PropertyBuilder<>(new StringListProperty("detect.detector.search.exclusion.patterns", emptyList()))
    ...
    public static final StringListProperty DETECT_DETECTOR_SEARCH_EXCLUSION_PATHS =
        new PropertyBuilder<>(new StringListProperty("detect.detector.search.exclusion.paths", emptyList()))
    ...
    public static final StringListProperty DETECT_DETECTOR_SEARCH_EXCLUSION_FILES =
        new PropertyBuilder<>(new StringListProperty("detect.detector.search.exclusion.files", emptyList()))
    ...
    public static final BooleanProperty DETECT_DETECTOR_SEARCH_EXCLUSION_DEFAULTS =
        new PropertyBuilder<>(new BooleanProperty("detect.detector.search.exclusion.defaults", true))
    ...
    public static final BooleanProperty DETECT_DIAGNOSTIC =
        new PropertyBuilder<>(new BooleanProperty("detect.diagnostic", false))
    ...
    public static final BooleanProperty DETECT_DIAGNOSTIC_EXTENDED =
        new PropertyBuilder<>(new BooleanProperty("detect.diagnostic.extended", false))
    ...
    public static final BooleanProperty DETECT_IGNORE_CONNECTION_FAILURES =
        new PropertyBuilder<>(new BooleanProperty("detect.ignore.connection.failures", false))
    ...
    public static final PassthroughProperty PHONEHOME_PASSTHROUGH =
        new PropertyBuilder<>(new PassthroughProperty("detect.phone.home.passthrough"))
    ...
    public static final PassthroughProperty DOCKER_PASSTHROUGH =
        new PropertyBuilder<>(new PassthroughProperty("detect.docker.passthrough"))
    ...
    public static final NullableStringProperty DETECT_DOCKER_IMAGE =
        new PropertyBuilder<>(new NullableStringProperty("detect.docker.image"))
    ...
    public static final NullableStringProperty DETECT_DOCKER_IMAGE_ID =
        new PropertyBuilder<>(new NullableStringProperty("detect.docker.image.id"))
            .setInfo("Docker Image ID", "6.1.0")
            .setHelp("The Docker image ID to inspect.")
            .setGroups(DetectGroup.DOCKER, DetectGroup.SOURCE_PATH)
            .build();

    public static final NullablePathProperty DETECT_DOCKER_INSPECTOR_AIR_GAP_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.docker.inspector.air.gap.path"))
    ...
    public static final NullablePathProperty DETECT_DOCKER_INSPECTOR_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.docker.inspector.path"))
    ...
    public static final NullableStringProperty DETECT_DOCKER_INSPECTOR_VERSION =
        new PropertyBuilder<>(new NullableStringProperty("detect.docker.inspector.version"))
    ...
    public static final NullablePathProperty DETECT_DOCKER_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.docker.path"))
    ...
    public static final BooleanProperty DETECT_DOCKER_PATH_REQUIRED =
        new PropertyBuilder<>(new BooleanProperty("detect.docker.path.required", false))
    ...
    public static final NullableStringProperty DETECT_DOCKER_PLATFORM_TOP_LAYER_ID =
        new PropertyBuilder<>(new NullableStringProperty("detect.docker.platform.top.layer.id"))
    ...
    public static final NullableStringProperty DETECT_DOCKER_TAR =
        new PropertyBuilder<>(new NullableStringProperty("detect.docker.tar"))
    ...
    public static final NullablePathProperty DETECT_DOTNET_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.dotnet.path"))
            .setInfo("dotnet Executable", "4.4.0")
            .setHelp("The path to the dotnet executable.")
            .setGroups(DetectGroup.NUGET, DetectGroup.GLOBAL)
            .build();

    public static final FilterableEnumListProperty<DetectorType> DETECT_EXCLUDED_DETECTOR_TYPES =
        new PropertyBuilder<>(new FilterableEnumListProperty<>("detect.excluded.detector.types", emptyList(), DetectorType.class))
    ...
    public static final BooleanProperty DETECT_FORCE_SUCCESS =
        new PropertyBuilder<>(new BooleanProperty("detect.force.success", false))
    ...
    public static final NullablePathProperty DETECT_GIT_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.git.path"))
    ...
    public static final NullablePathProperty DETECT_GO_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.go.path"))
    ...
    public static final NullableStringProperty DETECT_GRADLE_BUILD_COMMAND =
        new PropertyBuilder<>(new NullableStringProperty("detect.gradle.build.command"))
    ...
    public static final NullableStringProperty DETECT_GRADLE_EXCLUDED_CONFIGURATIONS =
        new PropertyBuilder<>(new NullableStringProperty("detect.gradle.excluded.configurations"))
    ...
    public static final NullableStringProperty DETECT_GRADLE_EXCLUDED_PROJECTS =
        new PropertyBuilder<>(new NullableStringProperty("detect.gradle.excluded.projects"))
    ...
    public static final NullableStringProperty DETECT_GRADLE_INCLUDED_CONFIGURATIONS =
        new PropertyBuilder<>(new NullableStringProperty("detect.gradle.included.configurations"))
    ...
    public static final NullableStringProperty DETECT_GRADLE_INCLUDED_PROJECTS =
        new PropertyBuilder<>(new NullableStringProperty("detect.gradle.included.projects"))
    ...
    public static final NullablePathProperty DETECT_GRADLE_INSPECTOR_AIR_GAP_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.gradle.inspector.air.gap.path"))
    ...
    public static final NullableStringProperty DETECT_GRADLE_INSPECTOR_VERSION =
        new PropertyBuilder<>(new NullableStringProperty("detect.gradle.inspector.version"))
    ...
    public static final NullablePathProperty DETECT_GRADLE_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.gradle.path"))
    ...
    public static final NullablePathProperty DETECT_HEX_REBAR3_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.hex.rebar3.path"))
    ...
    public static final BooleanProperty DETECT_IMPACT_ANALYSIS_ENABLED =
        new PropertyBuilder<>(new BooleanProperty("detect.impact.analysis.enabled", false))
    ...
    public static final NullablePathProperty DETECT_IMPACT_ANALYSIS_OUTPUT_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.impact.analysis.output.path"))
    ...
    public static final FilterableEnumListProperty<DetectorType> DETECT_INCLUDED_DETECTOR_TYPES =
        new PropertyBuilder<>(new FilterableEnumListProperty<>("detect.included.detector.types", emptyList(), DetectorType.class))
    ...
    public static final NullablePathProperty DETECT_JAVA_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.java.path"))
    ...
    public static final NullablePathProperty DETECT_LERNA_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.lerna.path"))
    ...
    public static final BooleanProperty DETECT_LERNA_INCLUDE_PRIVATE =
        new PropertyBuilder<>(new BooleanProperty("detect.lerna.include.private", false))
    ...
    public static final NullableStringProperty DETECT_MAVEN_BUILD_COMMAND =
        new PropertyBuilder<>(new NullableStringProperty("detect.maven.build.command"))
    ...
    public static final NullableStringProperty DETECT_MAVEN_EXCLUDED_MODULES =
        new PropertyBuilder<>(new NullableStringProperty("detect.maven.excluded.modules"))
    ...
    public static final NullableStringProperty DETECT_MAVEN_INCLUDED_MODULES =
        new PropertyBuilder<>(new NullableStringProperty("detect.maven.included.modules"))
    ...
    public static final NullablePathProperty DETECT_MAVEN_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.maven.path"))
    ...
    public static final NullableStringProperty DETECT_MAVEN_INCLUDED_SCOPES =
        new PropertyBuilder<>(new NullableStringProperty("detect.maven.included.scopes"))
    ...
    public static final NullableStringProperty DETECT_MAVEN_EXCLUDED_SCOPES =
        new PropertyBuilder<>(new NullableStringProperty("detect.maven.excluded.scopes"))
    ...
    public static final BooleanProperty DETECT_MAVEN_INCLUDE_PLUGINS =
        new PropertyBuilder<>(new BooleanProperty("detect.maven.include.plugins", false))
    ...
    public static final BooleanProperty DETECT_NOTICES_REPORT =
        new PropertyBuilder<>(new BooleanProperty("detect.notices.report", false))
    ...
    public static final PathProperty DETECT_NOTICES_REPORT_PATH =
        new PropertyBuilder<>(new PathProperty("detect.notices.report.path", new PathValue(".")))
    ...
    public static final NullableStringProperty DETECT_NPM_ARGUMENTS =
        new PropertyBuilder<>(new NullableStringProperty("detect.npm.arguments"))
    ...
    public static final BooleanProperty DETECT_NPM_INCLUDE_DEV_DEPENDENCIES =
        new PropertyBuilder<>(new BooleanProperty("detect.npm.include.dev.dependencies", true))
    ...
    public static final NullablePathProperty DETECT_NPM_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.npm.path"))
    ...
    public static final NullablePathProperty DETECT_NUGET_CONFIG_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.nuget.config.path"))
    ...
    public static final NullableStringProperty DETECT_NUGET_EXCLUDED_MODULES =
        new PropertyBuilder<>(new NullableStringProperty("detect.nuget.excluded.modules"))
    ...
    public static final BooleanProperty DETECT_NUGET_IGNORE_FAILURE =
        new PropertyBuilder<>(new BooleanProperty("detect.nuget.ignore.failure", false))
    ...
    public static final NullableStringProperty DETECT_NUGET_INCLUDED_MODULES =
        new PropertyBuilder<>(new NullableStringProperty("detect.nuget.included.modules"))
    ...
    public static final NullablePathProperty DETECT_NUGET_INSPECTOR_AIR_GAP_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.nuget.inspector.air.gap.path"))
    ...
    public static final NullableStringProperty DETECT_NUGET_INSPECTOR_VERSION =
        new PropertyBuilder<>(new NullableStringProperty("detect.nuget.inspector.version"))
    ...
    public static final StringListProperty DETECT_NUGET_PACKAGES_REPO_URL =
        new PropertyBuilder<>(new StringListProperty("detect.nuget.packages.repo.url", singletonList("https://api.nuget.org/v3/index.json")))
    ...
    public static final NullablePathProperty DETECT_OUTPUT_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.output.path"))
    ...
    public static final NullablePathProperty DETECT_TOOLS_OUTPUT_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.tools.output.path"))
    ...
    public static final BooleanProperty DETECT_PACKAGIST_INCLUDE_DEV_DEPENDENCIES =
        new PropertyBuilder<>(new BooleanProperty("detect.packagist.include.dev.dependencies", true))
    ...
    public static final BooleanProperty DETECT_PEAR_ONLY_REQUIRED_DEPS =
        new PropertyBuilder<>(new BooleanProperty("detect.pear.only.required.deps", false))
    ...
    public static final NullablePathProperty DETECT_PEAR_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.pear.path"))
    ...
    public static final NullableStringProperty DETECT_PIP_PROJECT_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.pip.project.name"))
    ...
    public static final NullableStringProperty DETECT_PIP_PROJECT_VERSION_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.pip.project.version.name"))
    ...
    public static final PathListProperty DETECT_PIP_REQUIREMENTS_PATH =
        new PropertyBuilder<>(new PathListProperty("detect.pip.requirements.path", emptyList()))
    ...
    public static final BooleanProperty DETECT_PIP_ONLY_PROJECT_TREE =
        new PropertyBuilder<>(new BooleanProperty("detect.pip.only.project.tree", false))
    ...
    public static final NullablePathProperty DETECT_PIPENV_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.pipenv.path"))
    ...
    public static final NullablePathProperty DETECT_SWIFT_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.swift.path"))
            .setInfo("Swift Executable", "6.0.0")
            .setHelp("Path of the swift executable.")
            .setGroups(DetectGroup.PATHS, DetectGroup.GLOBAL)
            .build();

    public static final FilterableEnumListProperty<PolicyRuleSeverityType> DETECT_POLICY_CHECK_FAIL_ON_SEVERITIES =
        new PropertyBuilder<>(
    ...
    public static final NullableStringProperty DETECT_PROJECT_APPLICATION_ID =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.application.id"))
    ...
    public static final NullableStringProperty DETECT_CUSTOM_FIELDS_PROJECT =
        new PropertyBuilder<>(new NullableStringProperty("detect.custom.fields.project"))
    ...
    public static final NullableStringProperty DETECT_CUSTOM_FIELDS_VERSION =
        new PropertyBuilder<>(new NullableStringProperty("detect.custom.fields.version"))
            .setInfo("Custom Fields", "5.6.0")
            .setHelp(
    ...
    public static final EnumListProperty<ProjectCloneCategoriesType> DETECT_PROJECT_CLONE_CATEGORIES =
        new PropertyBuilder<>(
    ...
    public static final NullableStringProperty DETECT_PROJECT_CODELOCATION_PREFIX =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.codelocation.prefix"))
    ...
    public static final NullableStringProperty DETECT_PROJECT_CODELOCATION_SUFFIX =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.codelocation.suffix"))
    ...
    public static final BooleanProperty DETECT_PROJECT_CODELOCATION_UNMAP =
        new PropertyBuilder<>(new BooleanProperty("detect.project.codelocation.unmap", false))
    ...
    public static final NullableStringProperty DETECT_PROJECT_DESCRIPTION =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.description"))
    ...
    public static final StringListProperty DETECT_PROJECT_USER_GROUPS =
        new PropertyBuilder<>(new StringListProperty("detect.project.user.groups", emptyList()))
    ...
    public static final StringListProperty DETECT_PROJECT_TAGS =
        new PropertyBuilder<>(new StringListProperty("detect.project.tags", emptyList()))
    ...
    public static final NullableStringProperty DETECT_PROJECT_DETECTOR =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.detector"))
    ...
    public static final BooleanProperty DETECT_PROJECT_LEVEL_ADJUSTMENTS =
        new PropertyBuilder<>(new BooleanProperty("detect.project.level.adjustments", true))
    ...
    public static final NullableStringProperty DETECT_PROJECT_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.name"))
    ...
    public static final NullableStringProperty DETECT_PARENT_PROJECT_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.parent.project.name"))
    ...
    public static final NullableStringProperty DETECT_PARENT_PROJECT_VERSION_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.parent.project.version.name"))
    ...
    public static final NullableIntegerProperty DETECT_PROJECT_TIER =
        new PropertyBuilder<>(new NullableIntegerProperty("detect.project.tier"))
    ...
    public static final EnumListProperty<DetectTool> DETECT_PROJECT_TOOL =
        new PropertyBuilder<>(new EnumListProperty<>("detect.project.tool", Arrays.asList(DetectTool.DOCKER, DetectTool.DETECTOR, DetectTool.BAZEL), DetectTool.class))
    ...
    public static final EnumProperty<LicenseFamilyLicenseFamilyRiskRulesReleaseDistributionType> DETECT_PROJECT_VERSION_DISTRIBUTION =
        new PropertyBuilder<>(new EnumProperty<>("detect.project.version.distribution", LicenseFamilyLicenseFamilyRiskRulesReleaseDistributionType.EXTERNAL, LicenseFamilyLicenseFamilyRiskRulesReleaseDistributionType.class))
    ...
    public static final NullableStringProperty DETECT_PROJECT_VERSION_NAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.version.name"))
    ...
    public static final NullableStringProperty DETECT_PROJECT_VERSION_NICKNAME =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.version.nickname"))
    ...
    public static final NullableStringProperty DETECT_PROJECT_VERSION_NOTES =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.version.notes"))
    ...
    public static final EnumProperty<ProjectVersionPhaseType> DETECT_PROJECT_VERSION_PHASE =
        new PropertyBuilder<>(new EnumProperty<>("detect.project.version.phase", ProjectVersionPhaseType.DEVELOPMENT, ProjectVersionPhaseType.class))
    ...
    public static final BooleanProperty DETECT_PROJECT_VERSION_UPDATE =
        new PropertyBuilder<>(new BooleanProperty("detect.project.version.update", false))
    ...
    public static final NullablePathProperty DETECT_PYTHON_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.python.path"))
            .setInfo("Python Executable", "3.0.0")
            .setHelp("The path to the Python executable.")
            .setGroups(DetectGroup.PYTHON, DetectGroup.GLOBAL)
            .build();

    public static final BooleanProperty DETECT_PYTHON_PYTHON3 =
        new PropertyBuilder<>(new BooleanProperty("detect.python.python3", false))
            .setInfo("Use Python3", "3.0.0")
            .setHelp("If true will use Python 3 if available on class path.")
            .setGroups(DetectGroup.PYTHON, DetectGroup.GLOBAL)
            .build();

    public static final LongProperty DETECT_REPORT_TIMEOUT =
        new PropertyBuilder<>(new LongProperty("detect.report.timeout", 300L))
    ...
    public static final EnumListProperty<DetectorType> DETECT_REQUIRED_DETECTOR_TYPES =
        new PropertyBuilder<>(new EnumListProperty<>("detect.required.detector.types", emptyList(), DetectorType.class))
    ...
    public static final BooleanProperty DETECT_RESOLVE_TILDE_IN_PATHS =
        new PropertyBuilder<>(new BooleanProperty("detect.resolve.tilde.in.paths", true))
    ...
    public static final BooleanProperty DETECT_RISK_REPORT_PDF =
        new PropertyBuilder<>(new BooleanProperty("detect.risk.report.pdf", false))
            .setInfo("Generate Risk Report (PDF)", "3.0.0")
            .setHelp("When set to true, a Black Duck risk report in PDF form will be created.")
            .setGroups(DetectGroup.REPORT, DetectGroup.GLOBAL, DetectGroup.REPORT_SETTING)
            .build();

    public static final PathProperty DETECT_RISK_REPORT_PDF_PATH =
        new PropertyBuilder<>(new PathProperty("detect.risk.report.pdf.path", new PathValue(".")))
    ...
    public static final BooleanProperty DETECT_RUBY_INCLUDE_RUNTIME_DEPENDENCIES =
        new PropertyBuilder<>(new BooleanProperty("detect.ruby.include.runtime.dependencies", true))
    ...
    public static final BooleanProperty DETECT_RUBY_INCLUDE_DEV_DEPENDENCIES =
        new PropertyBuilder<>(new BooleanProperty("detect.ruby.include.dev.dependencies", false))
    ...
    public static final NullableStringProperty DETECT_SBT_EXCLUDED_CONFIGURATIONS =
        new PropertyBuilder<>(new NullableStringProperty("detect.sbt.excluded.configurations"))
    ...
    public static final NullableStringProperty DETECT_SBT_INCLUDED_CONFIGURATIONS =
        new PropertyBuilder<>(new NullableStringProperty("detect.sbt.included.configurations"))
    ...
    public static final IntegerProperty DETECT_SBT_REPORT_DEPTH =
        new PropertyBuilder<>(new IntegerProperty("detect.sbt.report.search.depth", 3))
    ...
    public static final NullablePathProperty DETECT_SCAN_OUTPUT_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.scan.output.path"))
    ...
    public static final NullablePathProperty DETECT_SOURCE_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.source.path"))
    ...
    public static final BooleanProperty DETECT_TEST_CONNECTION =
        new PropertyBuilder<>(new BooleanProperty("detect.test.connection", false))
            .setInfo("Test Connection to Black Duck", "3.0.0")
            .setHelp("Test the connection to Black Duck with the current configuration.")
            .setGroups(DetectGroup.BLACKDUCK_SERVER, DetectGroup.GLOBAL)
            .build();

    public static final FilterableEnumListProperty<DetectTool> DETECT_TOOLS =
        new PropertyBuilder<>(new FilterableEnumListProperty<>("detect.tools", emptyList(), DetectTool.class))
    ...
    public static final FilterableEnumListProperty<DetectTool> DETECT_TOOLS_EXCLUDED =
        new PropertyBuilder<>(new FilterableEnumListProperty<>("detect.tools.excluded", emptyList(), DetectTool.class))
    ...
    public static final BooleanProperty DETECT_YARN_PROD_ONLY =
        new PropertyBuilder<>(new BooleanProperty("detect.yarn.prod.only", false))
    ...
    public static final EnumProperty<LogLevel> LOGGING_LEVEL_COM_SYNOPSYS_INTEGRATION =
        new PropertyBuilder<>(new EnumProperty<>("logging.level.com.synopsys.integration", LogLevel.INFO, LogLevel.class))
    ...
    public static final EnumProperty<LogLevel> LOGGING_LEVEL_DETECT =
        new PropertyBuilder<>(new EnumProperty<>("logging.level.detect", LogLevel.INFO, LogLevel.class))
    ...
    public static final BooleanProperty DETECT_WAIT_FOR_RESULTS =
        new PropertyBuilder<>(new BooleanProperty("detect.wait.for.results", false))
    ...
    @Deprecated
    public static final StringProperty DETECT_BITBAKE_REFERENCE_IMPL =
        new PropertyBuilder<>(new StringProperty("detect.bitbake.reference.impl", "-poky-linux"))
    ...
    @Deprecated
    public static final LongProperty DETECT_API_TIMEOUT =
        new PropertyBuilder<>(new LongProperty("detect.api.timeout", 300000L))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_URL =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.url"))
    ...
    @Deprecated
    public static final IntegerProperty BLACKDUCK_HUB_TIMEOUT =
        new PropertyBuilder<>(new IntegerProperty("blackduck.hub.timeout", 120))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_USERNAME =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.username"))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_PASSWORD =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.password"))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_API_TOKEN =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.api.token"))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_PROXY_HOST =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.host"))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_PROXY_PORT =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.port"))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_PROXY_USERNAME =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.username"))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_PROXY_PASSWORD =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.password"))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_PROXY_NTLM_DOMAIN =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.ntlm.domain"))
    ...
    @Deprecated
    public static final StringListProperty BLACKDUCK_HUB_PROXY_IGNORED_HOSTS =
        new PropertyBuilder<>(new StringListProperty("blackduck.hub.proxy.ignored.hosts", emptyList()))
    ...
    @Deprecated
    public static final NullableStringProperty BLACKDUCK_HUB_PROXY_NTLM_WORKSTATION =
        new PropertyBuilder<>(new NullableStringProperty("blackduck.hub.proxy.ntlm.workstation"))
    ...
    @Deprecated
    public static final BooleanProperty BLACKDUCK_HUB_TRUST_CERT =
        new PropertyBuilder<>(new BooleanProperty("blackduck.hub.trust.cert", false))
    ...
    @Deprecated
    public static final BooleanProperty BLACKDUCK_HUB_OFFLINE_MODE =
        new PropertyBuilder<>(new BooleanProperty("blackduck.hub.offline.mode", false))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_DISABLE_WITHOUT_HUB =
        new PropertyBuilder<>(new BooleanProperty("detect.disable.without.hub", false))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_DISABLE_WITHOUT_BLACKDUCK =
        new PropertyBuilder<>(new BooleanProperty("detect.disable.without.blackduck", false))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_SUPPRESS_CONFIGURATION_OUTPUT =
        new PropertyBuilder<>(new BooleanProperty("detect.suppress.configuration.output", false))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_SUPPRESS_RESULTS_OUTPUT =
        new PropertyBuilder<>(new BooleanProperty("detect.suppress.results.output", false))
    ...
    @Deprecated
    public static final NullableStringProperty DETECT_EXCLUDED_BOM_TOOL_TYPES =
        new PropertyBuilder<>(new NullableStringProperty("detect.excluded.bom.tool.types"))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_BOM_TOOL_SEARCH_EXCLUSION_DEFAULTS =
        new PropertyBuilder<>(new BooleanProperty("detect.bom.tool.search.exclusion.defaults", true))
    ...
    @Deprecated
    public static final StringListProperty DETECT_BOM_TOOL_SEARCH_EXCLUSION =
        new PropertyBuilder<>(new StringListProperty("detect.bom.tool.search.exclusion", emptyList()))
    ...
    @Deprecated
    public static final NullableStringProperty DETECT_INCLUDED_BOM_TOOL_TYPES =
        new PropertyBuilder<>(new NullableStringProperty("detect.included.bom.tool.types"))
    ...
    @Deprecated
    public static final NullableStringProperty DETECT_PROJECT_BOM_TOOL =
        new PropertyBuilder<>(new NullableStringProperty("detect.project.bom.tool"))
    ...
    @Deprecated
    public static final IntegerProperty DETECT_BOM_TOOL_SEARCH_DEPTH =
        new PropertyBuilder<>(new IntegerProperty("detect.bom.tool.search.depth", 0))
    ...
    @Deprecated
    public static final NullableStringProperty DETECT_REQUIRED_BOM_TOOL_TYPES =
        new PropertyBuilder<>(new NullableStringProperty("detect.required.bom.tool.types"))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_BOM_TOOL_SEARCH_CONTINUE =
        new PropertyBuilder<>(new BooleanProperty("detect.bom.tool.search.continue", false))
    ...
    @Deprecated
    public static final NullableStringProperty DETECT_GRADLE_INSPECTOR_REPOSITORY_URL =
        new PropertyBuilder<>(new NullableStringProperty("detect.gradle.inspector.repository.url"))
    ...
    @Deprecated
    public static final StringProperty DETECT_NUGET_INSPECTOR_NAME =
        new PropertyBuilder<>(new StringProperty("detect.nuget.inspector.name", "IntegrationNugetInspector"))
    ...
    @Deprecated
    public static final NullablePathProperty DETECT_NUGET_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.nuget.path"))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_HUB_SIGNATURE_SCANNER_DRY_RUN =
        new PropertyBuilder<>(new BooleanProperty("detect.hub.signature.scanner.dry.run", false))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_HUB_SIGNATURE_SCANNER_SNIPPET_MODE =
        new PropertyBuilder<>(new BooleanProperty("detect.hub.signature.scanner.snippet.mode", false))
    ...
    @Deprecated
    public static final StringListProperty DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_PATTERNS =
        new PropertyBuilder<>(new StringListProperty("detect.hub.signature.scanner.exclusion.patterns", emptyList()))
    ...
    @Deprecated
    public static final PathListProperty DETECT_HUB_SIGNATURE_SCANNER_PATHS =
        new PropertyBuilder<>(new PathListProperty("detect.hub.signature.scanner.paths", emptyList()))
    ...
    @Deprecated
    public static final StringListProperty DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS =
        new PropertyBuilder<>(new StringListProperty("detect.hub.signature.scanner.exclusion.name.patterns", Arrays.asList("node_modules")))
    ...
    @Deprecated
    public static final IntegerProperty DETECT_HUB_SIGNATURE_SCANNER_MEMORY =
        new PropertyBuilder<>(new IntegerProperty("detect.hub.signature.scanner.memory", 4096))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_HUB_SIGNATURE_SCANNER_DISABLED =
        new PropertyBuilder<>(new BooleanProperty("detect.hub.signature.scanner.disabled", false))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_DISABLED =
        new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.disabled", false))
    ...
    @Deprecated
    public static final NullablePathProperty DETECT_HUB_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.hub.signature.scanner.offline.local.path"))
    ...
    @Deprecated
    public static final NullablePathProperty DETECT_HUB_SIGNATURE_SCANNER_LOCAL_PATH =
        new PropertyBuilder<>(new NullablePathProperty("detect.hub.signature.scanner.local.path"))
    ...
    @Deprecated
    public static final NullableStringProperty DETECT_HUB_SIGNATURE_SCANNER_HOST_URL =
        new PropertyBuilder<>(new NullableStringProperty("detect.hub.signature.scanner.host.url"))
    ...
    @Deprecated
    public static final IntegerProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_PARALLEL_PROCESSORS =
        new PropertyBuilder<>(new IntegerProperty("detect.blackduck.signature.scanner.parallel.processors", 1))
    ...
    @Deprecated
    public static final IntegerProperty DETECT_HUB_SIGNATURE_SCANNER_PARALLEL_PROCESSORS =
        new PropertyBuilder<>(new IntegerProperty("detect.hub.signature.scanner.parallel.processors", 1))
    ...
    @Deprecated
    public static final NullableStringProperty DETECT_HUB_SIGNATURE_SCANNER_ARGUMENTS =
        new PropertyBuilder<>(new NullableStringProperty("detect.hub.signature.scanner.arguments"))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_SWIP_ENABLED =
        new PropertyBuilder<>(new BooleanProperty("detect.polaris.enabled", false))
    ...
    @Deprecated
    public static final EnumProperty<LogLevel> LOGGING_LEVEL_COM_BLACKDUCKSOFTWARE_INTEGRATION =
        new PropertyBuilder<>(new EnumProperty<>("logging.level.com.blackducksoftware.integration", LogLevel.INFO, LogLevel.class))
    ...
    @Deprecated
    public static final NullableStringProperty DETECT_MAVEN_SCOPE =
        new PropertyBuilder<>(new NullableStringProperty("detect.maven.scope"))
    ...
    @Deprecated
    public static final BooleanProperty DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MODE =
        new PropertyBuilder<>(new BooleanProperty("detect.blackduck.signature.scanner.snippet.mode", false))
    ...
    @Deprecated
    public static final NullableStringProperty POLARIS_URL =
        new PropertyBuilder<>(new NullableStringProperty("polaris.url"))
    ...
    @Deprecated
    public static final NullableStringProperty POLARIS_ACCESS_TOKEN =
        new PropertyBuilder<>(new NullableStringProperty("polaris.access.token"))
    ...
    @Deprecated
    public static final NullableStringProperty POLARIS_ARGUMENTS =
        new PropertyBuilder<>(new NullableStringProperty("polaris.arguments"))
    ...
    @Deprecated
    public static final NullableStringProperty POLARIS_COMMAND =
        new PropertyBuilder<>(new NullableStringProperty("polaris.command"))
    ...
    public static List<Property> allProperties() throws IllegalAccessException {
        ...
        for (Field field : allFields) {
            if (field.getType().equals(Property.class)) {
                Property property = (Property) field.get(Property.class);
