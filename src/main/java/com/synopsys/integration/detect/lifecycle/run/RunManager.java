...
public class RunManager {
    ...
    private UniversalToolsResult runUniversalProjectTools(
        ...
        if (detectToolFilter.shouldInclude(DetectTool.DETECTOR)) {
            ...
            String projectBomTool = detectConfiguration.getValueOrEmpty(DetectProperties.DETECT_PROJECT_DETECTOR).orElse(null);
            List<DetectorType> requiredDetectors = detectConfiguration.getValueOrDefault(DetectProperties.DETECT_REQUIRED_DETECTOR_TYPES);
            boolean buildless = detectConfiguration.getValueOrDefault(DetectProperties.DETECT_BUILDLESS);
