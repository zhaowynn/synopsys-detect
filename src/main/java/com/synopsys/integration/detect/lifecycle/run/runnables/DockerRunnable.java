...
public class DockerRunnable implements DetectRunnable {
    ...
    public DockerRunnable(DirectoryManager directoryManager, EventSystem eventSystem, DetectDetectableFactory detectDetectableFactory, DetectToolFilter detectToolFilter,
    ...
    public RunnableState run(RunnableState previousState) throws DetectUserFriendlyException, IntegrationException {
        ...
        boolean anythingFailed = previousState.isFailure() || detectableToolResult.isFailure();
