...
public class CodeLocationResultsRunStep {
    private final Logger logger = LoggerFactory.getLogger(getClass());
    private final EventSystem eventSystem;

    public CodeLocationResultsRunStep(EventSystem eventSystem) {
        this.eventSystem = eventSystem;
    }

    public CodeLocationResults run(CodeLocationAccumulator codeLocationAccumulator) {
