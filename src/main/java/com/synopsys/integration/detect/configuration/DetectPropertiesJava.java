...
public class DetectPropertiesJava {
    ...
    private DetectPropertiesJava() { }

    public static DetectProperty<NullableStringProperty> BLACKDUCK_API_TOKEN =
    ...
    public static DetectProperty<BooleanProperty> BLACKDUCK_OFFLINE_MODE =
    ...
    public static DetectProperty<NullableStringProperty> BLACKDUCK_PASSWORD =
    ...
    public static DetectProperty<NullableStringProperty> BLACKDUCK_PROXY_HOST =
    ...
    public static DetectProperty<StringListProperty> BLACKDUCK_PROXY_IGNORED_HOSTS =
    ...
    public static DetectProperty<NullableStringProperty> BLACKDUCK_PROXY_NTLM_DOMAIN =
    ...
    public static DetectProperty<NullableStringProperty> BLACKDUCK_PROXY_NTLM_WORKSTATION =
    ...
    public static DetectProperty<NullableStringProperty> BLACKDUCK_PROXY_PASSWORD =
    ...
    public static DetectProperty<NullableStringProperty> BLACKDUCK_PROXY_PORT =
    ...
    public static DetectProperty<NullableStringProperty> BLACKDUCK_PROXY_USERNAME =
    ...
    public static DetectProperty<IntegerProperty> BLACKDUCK_TIMEOUT =
    ...
    public static DetectProperty<BooleanProperty> BLACKDUCK_TRUST_CERT =
    ...
    public static DetectProperty<NullableStringProperty> BLACKDUCK_URL =
    ...
    public static DetectProperty<NullableStringProperty> BLACKDUCK_USERNAME =
    ...
    public static DetectProperty<IntegerProperty> DETECT_PARALLEL_PROCESSORS =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_BASH_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_BAZEL_PATH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_BAZEL_TARGET =
    ...
    public static DetectProperty<StringListProperty> DETECT_BAZEL_CQUERY_OPTIONS =
    ...
    public static DetectProperty<EnumProperty> DETECT_BAZEL_DEPENDENCY_RULE =
        new DetectProperty<>(new EnumProperty("detect.bazel.dependency.type", WorkspaceRule.UNSPECIFIED, WorkspaceRule.class))
    ...
    public static DetectProperty<NullablePathProperty> DETECT_BDIO_OUTPUT_PATH =
    ...
    public static DetectProperty<BooleanProperty> DETECT_BDIO2_ENABLED =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_BINARY_SCAN_FILE =
    ...
    public static DetectProperty<StringListProperty> DETECT_BINARY_SCAN_FILE_NAME_PATTERNS =
    ...
    public static DetectProperty<StringProperty> DETECT_BITBAKE_BUILD_ENV_NAME =
    ...
    public static DetectProperty<StringListProperty> DETECT_BITBAKE_PACKAGE_NAMES =
    ...
    public static DetectProperty<StringListProperty> DETECT_BITBAKE_SOURCE_ARGUMENTS =
    ...
    public static DetectProperty<IntegerProperty> DETECT_BITBAKE_SEARCH_DEPTH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_ARGUMENTS =
    ...
    public static DetectProperty<BooleanProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_COPYRIGHT_SEARCH =
    ...
    public static DetectProperty<BooleanProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_DRY_RUN =
    ...
    public static DetectProperty<StringListProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS =
        new DetectProperty<>(
    ...
    public static DetectProperty<IntegerProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_PATTERN_SEARCH_DEPTH =
    ...
    public static DetectProperty<StringListProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_EXCLUSION_PATTERNS =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_HOST_URL =
    ...
    public static DetectProperty<BooleanProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_LICENSE_SEARCH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_LOCAL_PATH =
    ...
    public static DetectProperty<IntegerProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_MEMORY =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH =
    ...
    public static DetectProperty<PathListProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_PATHS =
    ...
    public static DetectProperty<BooleanProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_UPLOAD_SOURCE_MODE =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_BOM_AGGREGATE_NAME =
    ...
    public static DetectProperty<BooleanProperty> DETECT_BUILDLESS =
    ...
    public static DetectProperty<BooleanProperty> DETECT_CLEANUP =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_CLONE_PROJECT_VERSION_NAME =
    ...
    public static DetectProperty<BooleanProperty> DETECT_CLONE_PROJECT_VERSION_LATEST =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_CODE_LOCATION_NAME =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_CONDA_ENVIRONMENT_NAME =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_CONDA_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_CPAN_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_CPANM_PATH =
    ...
    public static DetectProperty<StringProperty> DETECT_DEFAULT_PROJECT_VERSION_TEXT =
    ...
    public static DetectProperty<StringProperty> DETECT_DEFAULT_PROJECT_VERSION_TIMEFORMAT =
    ...
    public static DetectProperty<IntegerProperty> DETECT_DETECTOR_SEARCH_DEPTH =
    ...
    public static DetectProperty<BooleanProperty> DETECT_DETECTOR_SEARCH_CONTINUE =
    ...
    public static DetectProperty<StringListProperty> DETECT_DETECTOR_SEARCH_EXCLUSION =
    ...
    public static DetectProperty<StringListProperty> DETECT_DETECTOR_SEARCH_EXCLUSION_PATTERNS =
    ...
    public static DetectProperty<StringListProperty> DETECT_DETECTOR_SEARCH_EXCLUSION_PATHS =
    ...
    public static DetectProperty<StringListProperty> DETECT_DETECTOR_SEARCH_EXCLUSION_FILES =
    ...
    public static DetectProperty<BooleanProperty> DETECT_DETECTOR_SEARCH_EXCLUSION_DEFAULTS =
    ...
    public static DetectProperty<BooleanProperty> DETECT_IGNORE_CONNECTION_FAILURES =
    ...
    public static DetectProperty<PassthroughProperty> PHONEHOME_PASSTHROUGH =
    ...
    public static DetectProperty<PassthroughProperty> DOCKER_PASSTHROUGH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_DOCKER_IMAGE =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_DOCKER_IMAGE_ID =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_DOCKER_INSPECTOR_AIR_GAP_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_DOCKER_INSPECTOR_PATH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_DOCKER_INSPECTOR_VERSION =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_DOCKER_PATH =
    ...
    public static DetectProperty<BooleanProperty> DETECT_DOCKER_PATH_REQUIRED =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_DOCKER_PLATFORM_TOP_LAYER_ID =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_DOCKER_TAR =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_DOTNET_PATH =
    ...
    public static DetectProperty<BooleanProperty> DETECT_FORCE_SUCCESS =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_GIT_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_GO_PATH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_GRADLE_BUILD_COMMAND =
        new DetectProperty<>(new NullableStringProperty("detect.gradle.build.command"))
            .setInfo("Gradle Build Command", "3.0.0")
            .setHelp("Gradle command line arguments to add to the mvn/mvnw command line.",
    ...
    public static DetectProperty<NullableStringProperty> DETECT_GRADLE_EXCLUDED_CONFIGURATIONS =
        new DetectProperty<>(new NullableStringProperty("detect.gradle.excluded.configurations"))
            ...
            .setHelp("A comma-separated list of Gradle configurations to exclude.",
                "As Detect examines the Gradle project for dependencies, Detect will skip any Gradle configurations specified via this property.")
            .setGroups(DetectGroup.GRADLE, DetectGroup.SOURCE_SCAN)
            .setCategory(DetectCategory.Advanced);

    public static DetectProperty<NullableStringProperty> DETECT_GRADLE_EXCLUDED_PROJECTS =
        new DetectProperty<>(new NullableStringProperty("detect.gradle.excluded.projects"))
            ...
            .setHelp("A comma-separated list of Gradle sub-projects to exclude.",
                "As Detect examines the Gradle project for dependencies, Detect will skip any Gradle sub-projects specified via this property.")
            .setGroups(DetectGroup.GRADLE, DetectGroup.SOURCE_SCAN)
            .setCategory(DetectCategory.Advanced);

    public static DetectProperty<NullableStringProperty> DETECT_GRADLE_INCLUDED_CONFIGURATIONS =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_GRADLE_INCLUDED_PROJECTS =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_GRADLE_INSPECTOR_AIR_GAP_PATH =
        new DetectProperty<>(new NullablePathProperty("detect.gradle.inspector.air.gap.path"))
            ...
            .setHelp("The path to the directory containing the air gap dependencies for the gradle inspector.",
    ...
    public static DetectProperty<NullableStringProperty> DETECT_GRADLE_INSPECTOR_VERSION =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_GRADLE_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_HEX_REBAR3_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_JAVA_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_LERNA_PATH =
    ...
    public static DetectProperty<BooleanProperty> DETECT_LERNA_INCLUDE_PRIVATE =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_MAVEN_BUILD_COMMAND =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_MAVEN_EXCLUDED_MODULES =
        new DetectProperty<>(new NullableStringProperty("detect.maven.excluded.modules"))
            ...
            .setHelp("A comma-separated list of Maven modules (sub-projects) to exclude.",
                "As Detect parses the mvn dependency:tree output for dependencies, Detect will skip any Maven modules specified via this property.")
            .setGroups(DetectGroup.MAVEN, DetectGroup.SOURCE_SCAN)
            .setCategory(DetectCategory.Advanced);

    public static DetectProperty<NullableStringProperty> DETECT_MAVEN_INCLUDED_MODULES =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_MAVEN_PATH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_MAVEN_INCLUDED_SCOPES =
        new DetectProperty<>(new NullableStringProperty("detect.maven.included.scopes"))
            ...
            .setHelp("A comma separated list of Maven scopes. Output will be limited to dependencies within these scopes (overridden by exclude).",
                "If set, Detect will include only dependencies of the given Maven scope.")
            .setGroups(DetectGroup.MAVEN, DetectGroup.SOURCE_SCAN);

    public static DetectProperty<NullableStringProperty> DETECT_MAVEN_EXCLUDED_SCOPES =
        new DetectProperty<>(new NullableStringProperty("detect.maven.excluded.scopes"))
            ...
            .setHelp("A comma separated list of Maven scopes. Output will be limited to dependencies outside these scopes (overrides include).",
                "If set, Detect will include only dependencies outside of the given Maven scope.")
            .setGroups(DetectGroup.MAVEN, DetectGroup.SOURCE_SCAN);

    public static DetectProperty<BooleanProperty> DETECT_MAVEN_INCLUDE_PLUGINS =
    ...
    public static DetectProperty<BooleanProperty> DETECT_NOTICES_REPORT =
    ...
    public static DetectProperty<PathProperty> DETECT_NOTICES_REPORT_PATH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_NPM_ARGUMENTS =
    ...
    public static DetectProperty<BooleanProperty> DETECT_NPM_INCLUDE_DEV_DEPENDENCIES =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_NPM_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_NUGET_CONFIG_PATH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_NUGET_EXCLUDED_MODULES =
    ...
    public static DetectProperty<BooleanProperty> DETECT_NUGET_IGNORE_FAILURE =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_NUGET_INCLUDED_MODULES =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_NUGET_INSPECTOR_AIR_GAP_PATH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_NUGET_INSPECTOR_VERSION =
    ...
    public static DetectProperty<StringListProperty> DETECT_NUGET_PACKAGES_REPO_URL =
        new DetectProperty<>(new StringListProperty("detect.nuget.packages.repo.url", singletonList("https://api.nuget.org/v3/index.json")))
            ...
            .setHelp("The source for nuget packages",
                "Set this to \"https://www.nuget.org/api/v2/\" if your are still using a nuget client expecting the v2 api.")
            .setGroups(DetectGroup.NUGET, DetectGroup.GLOBAL);

    public static DetectProperty<NullablePathProperty> DETECT_OUTPUT_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_TOOLS_OUTPUT_PATH =
        new DetectProperty<>(new NullablePathProperty("detect.tools.output.path"))
            .setInfo("Detect Tools Output Path", "5.6.0")
            .setHelp("The path to the tools directory where detect should download and/or access things like the Signature Scanner that it shares over multiple runs.",
                "If set, Detect will use the given directory instead of using the default location of output path plus tools.")
            .setGroups(DetectGroup.PATHS, DetectGroup.GLOBAL)
            .setCategory(DetectCategory.Advanced);

    public static DetectProperty<BooleanProperty> DETECT_PACKAGIST_INCLUDE_DEV_DEPENDENCIES =
    ...
    public static DetectProperty<BooleanProperty> DETECT_PEAR_ONLY_REQUIRED_DEPS =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_PEAR_PATH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PIP_PROJECT_NAME =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PIP_PROJECT_VERSION_NAME =
    ...
    public static DetectProperty<PathListProperty> DETECT_PIP_REQUIREMENTS_PATH =
    ...
    public static DetectProperty<BooleanProperty> DETECT_PIP_ONLY_PROJECT_TREE =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_PIPENV_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_SWIFT_PATH =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_APPLICATION_ID =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_CUSTOM_FIELDS_PROJECT =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_CUSTOM_FIELDS_VERSION =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_CODELOCATION_PREFIX =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_CODELOCATION_SUFFIX =
    ...
    public static DetectProperty<BooleanProperty> DETECT_PROJECT_CODELOCATION_UNMAP =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_DESCRIPTION =
    ...
    public static DetectProperty<StringListProperty> DETECT_PROJECT_USER_GROUPS =
    ...
    public static DetectProperty<StringListProperty> DETECT_PROJECT_TAGS =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_DETECTOR =
        new DetectProperty<>(new NullableStringProperty("detect.project.detector"))
            .setInfo("Project Name/Version Detector", "4.0.0")
            .setHelp("The detector that will be used to determine the project name and version when multiple detector types. This property should be used with the detect.project.tool.",
    ...
    public static DetectProperty<BooleanProperty> DETECT_PROJECT_LEVEL_ADJUSTMENTS =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_NAME =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PARENT_PROJECT_NAME =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PARENT_PROJECT_VERSION_NAME =
    ...
    public static DetectProperty<NullableIntegerProperty> DETECT_PROJECT_TIER =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_VERSION_NAME =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_VERSION_NICKNAME =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_VERSION_NOTES =
    ...
    public static DetectProperty<BooleanProperty> DETECT_PROJECT_VERSION_UPDATE =
        new DetectProperty<>(new BooleanProperty("detect.project.version.update", false))
            .setInfo("Update Project Version", "4.0.0")
            .setHelp("If set to true, will update the Project Version with the configured properties. See detailed help for more information.",
    ...
    public static DetectProperty<NullablePathProperty> DETECT_PYTHON_PATH =
    ...
    public static DetectProperty<BooleanProperty> DETECT_PYTHON_PYTHON3 =
    ...
    public static DetectProperty<LongProperty> DETECT_REPORT_TIMEOUT =
        new DetectProperty<>(new LongProperty("detect.report.timeout", new Long(300)))
    ...
    public static DetectProperty<BooleanProperty> DETECT_RESOLVE_TILDE_IN_PATHS =
    ...
    public static DetectProperty<BooleanProperty> DETECT_RISK_REPORT_PDF =
    ...
    public static DetectProperty<PathProperty> DETECT_RISK_REPORT_PDF_PATH =
    ...
    public static DetectProperty<BooleanProperty> DETECT_RUBY_INCLUDE_RUNTIME_DEPENDENCIES =
    ...
    public static DetectProperty<BooleanProperty> DETECT_RUBY_INCLUDE_DEV_DEPENDENCIES =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_SBT_EXCLUDED_CONFIGURATIONS =
    ...
    public static DetectProperty<NullableStringProperty> DETECT_SBT_INCLUDED_CONFIGURATIONS =
    ...
    public static DetectProperty<IntegerProperty> DETECT_SBT_REPORT_DEPTH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_SCAN_OUTPUT_PATH =
    ...
    public static DetectProperty<NullablePathProperty> DETECT_SOURCE_PATH =
        new DetectProperty<>(new NullablePathProperty("detect.source.path"))
            .setInfo("Source Path", "3.0.0")
            .setHelp("The path to the project directory to inspect.",
    ...
    public static DetectProperty<BooleanProperty> DETECT_TEST_CONNECTION =
    ...
    public static DetectProperty<BooleanProperty> DETECT_YARN_PROD_ONLY =
    ...
    public static DetectProperty<EnumProperty> LOGGING_LEVEL_DETECT =
    ...
    public static DetectProperty<BooleanProperty> DETECT_WAIT_FOR_RESULTS =
    ...
    final public static String POLARIS_CLI_DEPRECATION_MESSAGE =
        "This property is being removed. Detect will no longer invoke the Polaris CLI.";

    @Deprecated
    public static DetectProperty<StringProperty> DETECT_BITBAKE_REFERENCE_IMPL =
    ...
    @Deprecated
    public static DetectProperty<LongProperty> DETECT_API_TIMEOUT =
        new DetectProperty<>(new LongProperty("detect.api.timeout", new Long(300000)))
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_URL =
    ...
    @Deprecated
    public static DetectProperty<IntegerProperty> BLACKDUCK_HUB_TIMEOUT =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_USERNAME =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_PASSWORD =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_API_TOKEN =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_PROXY_HOST =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_PROXY_PORT =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_PROXY_USERNAME =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_PROXY_PASSWORD =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_PROXY_NTLM_DOMAIN =
        new DetectProperty<>(new NullableStringProperty("blackduck.hub.proxy.ntlm.domain"))
            ...
            .setHelp("NTLM Proxy domain.")
            .setGroups(DetectGroup.BLACKDUCK_SERVER, DetectGroup.PROXY)
            .setDeprecated("This property is changing. Please use --blackduck.proxy.ntlm.domain in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<StringListProperty> BLACKDUCK_HUB_PROXY_IGNORED_HOSTS =
        new DetectProperty<>(new StringListProperty("blackduck.hub.proxy.ignored.hosts", emptyList()))
            ...
            .setGroups(DetectGroup.BLACKDUCK_SERVER, DetectGroup.PROXY)
            .setDeprecated("This property is changing. Please use --blackduck.proxy.ignored.hosts in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<NullableStringProperty> BLACKDUCK_HUB_PROXY_NTLM_WORKSTATION =
        new DetectProperty<>(new NullableStringProperty("blackduck.hub.proxy.ntlm.workstation"))
            ...
            .setHelp("NTLM Proxy workstation.")
            .setGroups(DetectGroup.BLACKDUCK_SERVER, DetectGroup.PROXY)
            .setDeprecated("This property is changing. Please use --blackduck.proxy.ntlm.workstation in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<BooleanProperty> BLACKDUCK_HUB_TRUST_CERT =
    ...
    @Deprecated
    public static DetectProperty<BooleanProperty> BLACKDUCK_HUB_OFFLINE_MODE =
    ...
    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_DISABLE_WITHOUT_HUB =
    ...
    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_DISABLE_WITHOUT_BLACKDUCK =
    ...
    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_SUPPRESS_CONFIGURATION_OUTPUT =
    ...
    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_SUPPRESS_RESULTS_OUTPUT =
        new DetectProperty<>(new BooleanProperty("detect.suppress.results.output", false))
            ...
            .setGroups(DetectGroup.LOGGING)
            .setDeprecated("This property is being removed. Results can no longer be suppressed individually. Log level can be used.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<NullableStringProperty> DETECT_EXCLUDED_BOM_TOOL_TYPES =
    ...
    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_BOM_TOOL_SEARCH_EXCLUSION_DEFAULTS =
    ...
    @Deprecated
    public static DetectProperty<StringListProperty> DETECT_BOM_TOOL_SEARCH_EXCLUSION =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> DETECT_INCLUDED_BOM_TOOL_TYPES =
        new DetectProperty<>(new NullableStringProperty("detect.included.bom.tool.types"))
            ...
            .setDeprecated("This property is changing. Please use --detect.included.detector.types in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<NullableStringProperty> DETECT_PROJECT_BOM_TOOL =
    ...
    @Deprecated
    public static DetectProperty<IntegerProperty> DETECT_BOM_TOOL_SEARCH_DEPTH =
        new DetectProperty<>(new IntegerProperty("detect.bom.tool.search.depth", 0))
            .setInfo("Detect Bom Tool Search Depth", "3.2.0")
            .setHelp("Depth of subdirectories within the source directory to search for files that indicate whether a detector applies.",
                "A value of 0 (the default) tells Detect not to search any subdirectories, a value of 1 tells Detect to search first-level subdirectories, etc.")
            .setGroups(DetectGroup.PATHS, DetectGroup.DETECTOR)
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> DETECT_REQUIRED_BOM_TOOL_TYPES =
        new DetectProperty<>(new NullableStringProperty("detect.required.bom.tool.types"))
            ...
            .setGroups(DetectGroup.DETECTOR, DetectGroup.DETECTOR)
            .setDeprecated("This property is changing. Please use --detect.required.detector.types in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_BOM_TOOL_SEARCH_CONTINUE =
        new DetectProperty<>(new BooleanProperty("detect.bom.tool.search.continue", false))
            ...
            .setHelp(
                ...
                "If true, Detect will find Maven projects that are in subdirectories of a Maven project and Gradle projects that are in subdirectories of Gradle projects, etc. "
                    ...
                    "If false, Detect will only find bom tools in subdirectories of a project if they are of a different type such as an Npm project in a subdirectory of a Gradle project .")
            .setGroups(DetectGroup.PATHS, DetectGroup.DETECTOR)
            .setDeprecated("This property is changing. Please use --detect.detector.search.continue in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<NullableStringProperty> DETECT_GRADLE_INSPECTOR_REPOSITORY_URL =
        new DetectProperty<>(new NullableStringProperty("detect.gradle.inspector.repository.url"))
            ...
            .setDeprecated(
                "In the future, the gradle inspector will no longer be downloaded from a custom repository, please use Detect Air Gap instead.",
                DetectMajorVersion.SIX, DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<StringProperty> DETECT_NUGET_INSPECTOR_NAME =
        new DetectProperty<>(new StringProperty("detect.nuget.inspector.name", "IntegrationNugetInspector"))
            ...
            .setHelp("Name of the Nuget Inspector package and the Nuget Inspector exe. (Do not include '.exe'.)",
    ...
    @Deprecated
    public static DetectProperty<NullablePathProperty> DETECT_NUGET_PATH =
        new DetectProperty<>(new NullablePathProperty("detect.nuget.path"))
            ...
            .setGroups(DetectGroup.NUGET)
            .setDeprecated("In the future, Detect will no longer need a nuget executable as it will download the inspector from Artifactory exclusively.",
                DetectMajorVersion.SIX, DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_HUB_SIGNATURE_SCANNER_DRY_RUN =
        new DetectProperty<>(new BooleanProperty("detect.hub.signature.scanner.dry.run", false))
            ...
            .setGroups(DetectGroup.SIGNATURE_SCANNER)
            .setDeprecated("This property is changing. Please use --detect.blackduck.signature.scanner.dry.run in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_HUB_SIGNATURE_SCANNER_SNIPPET_MODE =
        new DetectProperty<>(new BooleanProperty("detect.hub.signature.scanner.snippet.mode", false))
            ...
            .setGroups(DetectGroup.SIGNATURE_SCANNER)
            .setDeprecated("This property is changing. Please use --detect.blackduck.signature.scanner.snippet.mode in the future.",
                DetectMajorVersion.SIX, DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<StringListProperty> DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_PATTERNS =
        new DetectProperty<>(new StringListProperty("detect.hub.signature.scanner.exclusion.patterns", emptyList()))
            ...
            .setHelp("A comma-separated list of values to be used with the Signature Scanner --exclude flag.")
            .setGroups(DetectGroup.SIGNATURE_SCANNER)
            .setDeprecated("This property is changing. Please use --detect.blackduck.signature.scanner.exclusion.patterns in the future.",
                DetectMajorVersion.SIX, DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<PathListProperty> DETECT_HUB_SIGNATURE_SCANNER_PATHS =
        new DetectProperty<>(new PathListProperty("detect.hub.signature.scanner.paths", emptyList()))
            ...
            .setHelp("These paths and only these paths will be scanned.")
            .setGroups(DetectGroup.SIGNATURE_SCANNER)
            .setDeprecated("This property is changing. Please use --detect.blackduck.signature.scanner.paths in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<StringListProperty> DETECT_HUB_SIGNATURE_SCANNER_EXCLUSION_NAME_PATTERNS =
        new DetectProperty<>(new StringListProperty("detect.hub.signature.scanner.exclusion.name.patterns", Arrays.asList("node_modules")))
            ...
            .setGroups(DetectGroup.SIGNATURE_SCANNER)
            .setDeprecated(
                "This property is changing. Please use --detect.blackduck.signature.scanner.exclusion.name.patterns in the future.",
                DetectMajorVersion.SIX, DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<IntegerProperty> DETECT_HUB_SIGNATURE_SCANNER_MEMORY =
        new DetectProperty<>(new IntegerProperty("detect.hub.signature.scanner.memory", 4096))
            ...
            .setHelp("The memory for the scanner to use.")
            .setGroups(DetectGroup.SIGNATURE_SCANNER)
            .setDeprecated("This property is changing. Please use --detect.blackduck.signature.scanner.memory in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_HUB_SIGNATURE_SCANNER_DISABLED =
    ...
    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_DISABLED =
    ...
    @Deprecated
    public static DetectProperty<NullablePathProperty> DETECT_HUB_SIGNATURE_SCANNER_OFFLINE_LOCAL_PATH =
        new DetectProperty<>(new NullablePathProperty("detect.hub.signature.scanner.offline.local.path"))
            ...
            .setDeprecated("This property is changing. Please use --detect.blackduck.signature.scanner.offline.local.path in the future.",
                DetectMajorVersion.SIX, DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<NullablePathProperty> DETECT_HUB_SIGNATURE_SCANNER_LOCAL_PATH =
        new DetectProperty<>(new NullablePathProperty("detect.hub.signature.scanner.local.path"))
            ...
            .setHelp(
                "To use a local signature scanner, specify the path where the signature scanner was unzipped. This will likely look similar to 'scan.cli-x.y.z' and includes the 'bin, icon, jre, and lib' directories of the expanded scan.cli.")
            .setGroups(DetectGroup.SIGNATURE_SCANNER, DetectGroup.OFFLINE)
            .setDeprecated("This property is changing. Please use --detect.blackduck.signature.scanner.local.path in the future.",
                DetectMajorVersion.SIX, DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<NullableStringProperty> DETECT_HUB_SIGNATURE_SCANNER_HOST_URL =
        new DetectProperty<>(new NullableStringProperty("detect.hub.signature.scanner.host.url"))
            ...
            .setGroups(DetectGroup.SIGNATURE_SCANNER)
            .setDeprecated("This property is changing. Please use --detect.blackduck.signature.scanner.host.url in the future.",
                DetectMajorVersion.SIX, DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<IntegerProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_PARALLEL_PROCESSORS =
    ...
    @Deprecated
    public static DetectProperty<IntegerProperty> DETECT_HUB_SIGNATURE_SCANNER_PARALLEL_PROCESSORS =
        new DetectProperty<>(new IntegerProperty("detect.hub.signature.scanner.parallel.processors", 1))
            ...
            .setHelp(
                "The number of scans to run in parallel, defaults to 1, but if you specify -1, the number of processors on the machine will be used.")
            .setGroups(DetectGroup.SIGNATURE_SCANNER)
            .setDeprecated("This property is changing. Please use --detect.parallel.processors in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<NullableStringProperty> DETECT_HUB_SIGNATURE_SCANNER_ARGUMENTS =
        new DetectProperty<>(new NullableStringProperty("detect.hub.signature.scanner.arguments"))
            ...
            .setGroups(DetectGroup.SIGNATURE_SCANNER)
            .setDeprecated("This property is changing. Please use --detect.blackduck.signature.scanner.arguments in the future.",
                DetectMajorVersion.SIX, DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_SWIP_ENABLED =
    ...
    @Deprecated
    public static DetectProperty<EnumProperty> LOGGING_LEVEL_COM_BLACKDUCKSOFTWARE_INTEGRATION =
        new DetectProperty<>(new EnumProperty("logging.level.com.blackducksoftware.integration", LogLevel.INFO, LogLevel.class))
            ...
            .setHelp("The logging level of Detect.")
            .setGroups(DetectGroup.LOGGING, DetectGroup.GLOBAL)
            .setDeprecated("This property is changing. Please use --logging.level.com.synopsys.integration in the future.", DetectMajorVersion.SIX,
                DetectMajorVersion.SEVEN);

    @Deprecated
    public static DetectProperty<NullableStringProperty> DETECT_MAVEN_SCOPE =
        new DetectProperty<>(new NullableStringProperty("detect.maven.scope"))
            .setInfo("Dependency Scope Included", "3.0.0")
            .setHelp("The name of a Maven scope. Output will be limited to dependencies with this scope.",
                "If set, Detect will include only dependencies of the given Maven scope.")
            .setGroups(DetectGroup.MAVEN, DetectGroup.SOURCE_SCAN)
    ...
    @Deprecated
    public static DetectProperty<BooleanProperty> DETECT_BLACKDUCK_SIGNATURE_SCANNER_SNIPPET_MODE =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> POLARIS_URL =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> POLARIS_ACCESS_TOKEN =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> POLARIS_ARGUMENTS =
    ...
    @Deprecated
    public static DetectProperty<NullableStringProperty> POLARIS_COMMAND =
