...
public class ProjectDecisionOperation {
    ...
    public NameVersion execute(List<DetectToolProjectInfo> input) {
        return projectNameVersionDecider.decideProjectNameVersion(runOptions.getPreferredTools(), input);
    }
}
